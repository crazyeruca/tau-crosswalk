...
namespace CrosswalkImpl
{
    public class Crosswalk : CrosswalkBase
    {
        public Crosswalk()
        {
    ...
    public class CrosswalkSingleton : CrosswalkSingletonBase
    {
        public CrosswalkSingleton()
        {
    ...
    public class CrosswalkFactory : CrosswalkFactoryBase
    {
    }
}
